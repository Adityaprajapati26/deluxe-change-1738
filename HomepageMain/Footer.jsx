...
const Footer = () => {
	...
	return (
		<>
			<div style={{ marginLeft: "80px", width: "85%" }}>
				<Container>
					<Left>
						<Title>Info</Title>
						<List>
							<ListItem className="li">Search</ListItem>
							<ListItem className="li">Terms and Service</ListItem>
							<ListItem className="li">Refund Policy</ListItem>
							<ListItem className="li">Wholesale</ListItem>
							<ListItem className="li">Wholesale Signup form</ListItem>
							<ListItem className="li">Shipping</ListItem>
						</List>
					</Left>
					<Center>
